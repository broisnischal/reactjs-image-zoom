...
const Zoom = (props) => {
    var _a;
    const { className, height, borderpixel, color, bordercolor, maxwidth, width, repeat, position, size, bgsize, cursor, url } = (0, react_2.useMemo)(() => (Object.assign(Object.assign({}, DEFAULT), props)), [props]);
